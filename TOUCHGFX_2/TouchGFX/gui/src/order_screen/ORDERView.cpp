...
void ORDERView::putMenu()
{
  presenter->updateItem(textID, counter, price);
}
...
void ORDERView::menu0()
{
  ...
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION0));
...
void ORDERView::menu1()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION1));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu2()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION2));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu3()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION3));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu4()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION4));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu5()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION5));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu6()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION6));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu7()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION7));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu8()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION8));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu9()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION9));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu10()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION10));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu11()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION11));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu12()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION12));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu13()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION13));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu14()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION14));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu15()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION15));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu16()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION16));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu17()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION17));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
...
void ORDERView::menu18()
{
  ...
  menuImage.setBitmap(touchgfx::Bitmap(imageCode));
  textArea3.setTypedText(touchgfx::TypedText(textID));
  menuDescription.setTypedText(touchgfx::TypedText(T_DESCRIPTION18));
  formatPriceWithComma(price, menuPriceBuffer, MENUPRICE_SIZE);
  formatPriceWithComma(price, totalPriceBuffer, TOTALPRICE_SIZE);
  Unicode::snprintf(menuCountBuffer, MENUCOUNT_SIZE, "%d", counter);
  menuCount.invalidate();
