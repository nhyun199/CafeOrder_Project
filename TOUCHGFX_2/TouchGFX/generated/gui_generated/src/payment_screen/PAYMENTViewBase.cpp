...
void PAYMENTViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &backButton)
    {
        ...
        //Go to ORDER with screen transition towards North
        application().gotoORDERScreenCoverTransitionNorth();
    }
    if (&src == &paymentButton)
    {
        //paymentInfoTransmitt
        //When paymentButton clicked call virtual function
        //Call transmittServer
        transmittServer();
    }
}
