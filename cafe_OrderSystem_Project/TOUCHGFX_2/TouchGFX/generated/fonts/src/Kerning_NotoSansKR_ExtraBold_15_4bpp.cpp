...
KEEP extern const touchgfx::KerningNode kerning_NotoSansKR_ExtraBold_15_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x002C, -3 },  // (First char = [0x002C, ,], Second char = [0x002A, *], Kerning dist = -3)
    { 0x002E, -3 },  // (First char = [0x002E, .], Second char = [0x002A, *], Kerning dist = -3)
    ...
    { 0x002F, -1 },  // (First char = [0x002F, /], Second char = [0x0061, a], Kerning dist = -1)
